...
class InventoryManagementSystem:
    ...
    def display_menu(self):
        ...
        print("1. Add Product" if self.current_user.role == "Admin" else "")
        print("2. Update Product" if self.current_user.role == "Admin" else "")
        print("3. Delete Product" if self.current_user.role == "Admin" else "")
        print("4. View Product")
        print("5. View All Products")
        print("6. Search Product")
        print("7. Adjust Stock" if self.current_user.role == "Admin" else "")
        print("0. Exit")
    ...
    def search_product(self):
        ...
        results = self.inventory_manager.search_products(name=name, category=category)
        if results:
    ...
    def adjust_stock(self):
        ...
        amount = int(input("Enter amount to adjust (+/-): "))
        try:
